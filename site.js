...
${navGroup('future','Who Got Next?','/who-got-next.html',menuSection('The next wave',[['Class Is in Session','/class-is-in-session.html'],['The Call Up','/the-call-up.html'],['Expansion Watch','/expansion-watch.html']]))}
${navGroup('offseason','No Offseason','/no-offseason.html',`<div class="nav-menu-grid">${menuSection('World stage',[['FIBA World Cup','/fiba-world-cup.html']])}${menuSection('Pro winter basketball',[['Unrivaled','/unrivaled.html'],['Athletes Unlimited','/athletes-unlimited.html']])}</div>`,'nav-group-wide')}
...
'/fiba-world-cup.html':['No Offseason','/no-offseason.html','FIBA World Cup'],
...
const h=hierarchyMap[location.pathname];const crumbs=document.querySelector('.page-crumbs');if(crumbs&&h&&!['/around-the-w.html','/playerpedia.html','/who-got-next.html','/no-offseason.html'].includes(location.pathname))crumbs.innerHTML=`<a href="/">Home</a><span>›</span><a href="${h[1]}">${h[0]}</a><span>›</span><b>${h[2]}</b>`;document.querySelectorAll('[data-current-year]').forEach(el=>el.textContent=new Date().getFullYear());
...
const navSections={
  ...
  future:['/who-got-next.html','/class-is-in-session.html','/the-call-up.html','/expansion-watch.html','/expansion-w.html','/expansion-upshot.html','/expansion-unrivaled.html','/expansion-athletes-unlimited.html','/cleveland-sirens.html','/detroit-expansion.html','/philadelphia-expansion.html','/expansion-draft-101.html','/past-expansion-waves.html'],
  offseason:['/no-offseason.html','/fiba-world-cup.html','/fiba-watchers-guide.html','/unrivaled.html','/athletes-unlimited.html'],
...
coreSearch.push(['Early 2027 WNBA Mock Draft','Food for Thought','/2027-wnba-mock-draft.html','juju watkins houston comets draft prospects big board mock college hannah hidalgo madison booker']);
coreSearch.push(
  ...
  ['FIBA World Cup','No Offseason','/fiba-world-cup.html','2026 berlin team usa international basketball schedule standings results'],
...
function addMockDraftRoute(){if(location.pathname!=='/who-got-next.html'||document.querySelector('.mock-draft-route'))return;const grid=document.querySelector('.next-desk-grid');if(!grid)return;const link=document.createElement('a');link.className='mock-draft-route';link.href='/2027-wnba-mock-draft.html';link.innerHTML='<div class="mock-draft-route-number">01</div><div><span>NEW · FOOD FOR THOUGHT</span><h3>JuJu to Houston?</h3><p>Open the early 2027 WNBA mock draft: all 15 first-round projections, real player photos, current pick ownership, team fits and the lottery questions that can change the board.</p></div><div class="mock-draft-route-cta">OPEN THE MOCK DRAFT →</div>';grid.insertAdjacentElement('afterend',link);}
