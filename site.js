...
coreSearch.push(['Early 2027 WNBA Mock Draft','Food for Thought','/2027-wnba-mock-draft.html','juju watkins toronto tempo houston comets draft prospects big board mock college hannah hidalgo madison booker smya nichols zhang ziyu china world cup lottery odds']);
coreSearch.push(
...
function addMockDraftRoute(){if(location.pathname!=='/who-got-next.html'||document.querySelector('.mock-draft-route'))return;const grid=document.querySelector('.next-desk-grid');if(!grid)return;const link=document.createElement('a');link.className='mock-draft-route';link.href='/2027-wnba-mock-draft.html';link.innerHTML='<div class="mock-draft-route-number">02</div><div><span>UPDATED · FOOD FOR THOUGHT</span><h3>Toronto or Houston?</h3><p>Open the updated 2027 WNBA mock draft: Toronto and Houston share the best estimated odds, JuJu Watkins stays No. 1 and Zhang Ziyu enters at No. 12.</p></div><div class="mock-draft-route-cta">OPEN THE MOCK DRAFT →</div>';grid.insertAdjacentElement('afterend',link);}
