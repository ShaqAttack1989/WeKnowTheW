...
module.exports=async function handler(req,res){
  ...
  try{
    ...
    return res.status(200).json({season,updatedAt:new Date().toISOString(),source,sourceUrls:['https://stats.wnba.com/players/traditional/',pg.source,adv.source],minGames,
