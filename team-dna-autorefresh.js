(()=>{
  ...
  function refreshBoards(reason='scheduled'){
  ...
  const statusWatcher=new MutationObserver(()=>annotateStatus());
  statusWatcher.observe(document.documentElement,{childList:true,subtree:true});
  setTimeout(()=>{annotateStatus();},750);
  setTimeout(()=>{annotateStatus();statusWatcher.disconnect();},10000);
