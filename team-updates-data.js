(()=>{
  ...
  const CURATED={
    ...
    'los-angeles-sparks':[
      ...
      {date:'2026-09-24',category:'story',kind:'FINAL GAME · LEGACY',title:'Nneka Ogwumike',detail:'Los Angeles finished 16-28 after a 76-75 loss to Golden State. Ogwumike closed her WNBA career with 17 points and 15 rebounds; her 19th double-double of 2026 set a Sparks single-season record, and the franchise announced its new El Segundo practice facility will be named for her.',href:'https://www.latimes.com/sports/sparks/story/2026-09-24/los-angeles-sparks-golden-state-valkyries-wnba-game-recap',priority:11},
      ...
      {date:'2026-09-03',category:'story',kind:'HONOR · FREEDOM AWARD',title:'Nneka Ogwumike',detail:'The National Civil Rights Museum named Ogwumike a 2026 Freedom Award honoree, recognizing a public legacy that includes player leadership, mentoring, girls in sports and civic engagement.',href:'https://civilrightsmuseum.org/freedom-award/honorees-entertainment/',priority:9}
    ],
    'minnesota-lynx':[
